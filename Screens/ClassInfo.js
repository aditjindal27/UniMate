...
import { StyleSheet, SafeAreaView, ActivityIndicator, Text, Alert, View, TouchableOpacity, Image, Platform } from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.container} key={unique}>
      ...
      <WebView
        ...
        source={{ uri: 'https://gtcourses.herokuapp.com/info' }}
